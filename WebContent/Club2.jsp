...
<%
		...
		pstmt = conn.prepareStatement("INSERT INTO \"Student_Club\"(student_id, club_id) VALUES (?, ?)");
		pstmt.setString(1, request.getParameter("student_id"));
		pstmt.setInt(2, Integer.parseInt(request.getParameter("club_id")));
		pstmt.executeUpdate();
		
		conn.commit();
		conn.setAutoCommit(true);
%>
	Your association with club <%=request.getParameter("name") %> has been successfully updated.
<%
	}
%>
<%
